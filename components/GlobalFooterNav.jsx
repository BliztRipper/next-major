        ...
        <div className="react-tabs">
          ...
          <ul className="react-tabs__tab-list" role="tablist">
            <div className="react-tabs__tabs-container">
              <li onClick={this.backToHome.bind(this,1)} className={this.props.selectBy === 'cinema' ? 'react-tabs__tab':'react-tabs__tab react-tabs__tab--selected'} role="tab" id="react-tabs-0" aria-selected="false" aria-disabled="false"
              ...
              <li onClick={this.backToHome.bind(this,2)} className={this.props.selectBy === 'cinema' ? 'react-tabs__tab react-tabs__tab--selected':'react-tabs__tab'} role="tab" id="react-tabs-2" aria-selected="true"
